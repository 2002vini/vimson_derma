...
csv_paths=['api/management/commands/facecare_products_output.csv',
            'api/management/commands/haircare_products_output.csv',
            'api/management/commands/products_output.csv']
